...
func TestGetAllProductions(t *testing.T) {
	...
	table := []struct {
		...
		{p: []string{""}, want: []string{}, wantErr: false},
		{p: []string{";"}, want: []string{}, wantErr: false},
		{p: []string{"", ""}, want: []string{}, wantErr: false},
		{p: []string{";", ";", ";"}, want: []string{}, wantErr: false},
		{p: []string{"abc;"}, want: []string{"abc"}, wantErr: false},
		{p: []string{"<b>;"}, want: []string{"1", "2", "3"}, wantErr: false},
		{p: []string{"<g>;"}, want: []string{"abc"}, wantErr: false},
		{p: []string{"<h>;"}, want: []string{"123bc"}, wantErr: false},
		{p: []string{"<i>;"}, want: []string{"a1c", "a2c", "a3c"}, wantErr: false},
		{
			p: []string{"<j>;"}, want: []string{
		...
		{p: []string{"a{}b//c/0.1/;"}, want: []string{"a{}b//c/0.1/"}, wantErr: false},
		{p: []string{"a{}/0.1/b/0.1/{}c;"}, want: []string{"a{}/0.1/b/0.1/{}c"}, wantErr: false},
		{p: []string{"abc<a>;"}, want: []string{"abc123"}, wantErr: false},
		{p: []string{"abc<l>;"}, want: []string{"abc<l>"}, wantErr: true},
		{
			p:    []string{"abc<a><b><c>;"},
			want: []string{"abc1231123", "abc123113", "abc1232123", "abc123213", "abc1233123", "abc123313"}, wantErr: false,
		},
		{p: []string{"abc(<g>|<h>|<i>);"}, want: []string{"abcabc", "abc123bc", "abca1c", "abca2c", "abca3c"}, wantErr: false},
		{p: []string{"abc<g><g><g>;"}, want: []string{"abcabcabcabc"}, wantErr: false},
		{p: []string{"abc;", "def;", "ghi;"}, want: []string{"abc", "def", "ghi"}, wantErr: false},
		{p: []string{"abc<a>;", "def<h>;", "<b>;"}, want: []string{"abc123", "def123bc", "1", "2", "3"}, wantErr: false},
		{
			p: []string{"abc<a><b><c>;", "def[<h>];", "g((hi)|(jk));"}, want: []string{
				"abc1231123", "abc123113", "abc1232123", "abc123213", "abc1233123", "abc123313", "def", "def123bc", "ghi",
				"gjk",
			}, wantErr: false,
		},
		{
			p: []string{"abc(<g>|<h>|<i>);", "def[<g>|<h>|<i>];", "ghi<b><b><b>;"}, want: []string{
		...
		{
			p: []string{"abc<g><g><g>;", "<h><i>;", "<j>|<k>;"}, want: []string{
...
func TestGetAllProductionsE2E(t *testing.T) {
	...
	table := []struct {
		...
		{p: "data/tests/test0.jsgf", want: productions, wantErr: false},
		{p: "data/tests/test1.jsgf", want: productions, wantErr: false},
		{p: "data/tests/test2.jsgf", want: productions, wantErr: true}, // returns error but is still resolvable, figure out how to validate completness before imports
		{p: "data/tests/test3.jsgf", want: productions, wantErr: false},
		{p: "data/tests/test4.jsgf", want: productions, wantErr: false},
		{p: "data/tests/test5.jsgf", want: productions, wantErr: false},
		{p: "data/tests/a.jsgf", want: []string{}, wantErr: false},
		{p: "data/tests/b.jsgf", want: []string{}, wantErr: false},
		{p: "data/tests/dir0/c.jsgf", want: []string{}, wantErr: false},
		{p: "data/tests/dir0/dir1/d.jsgf", want: []string{}, wantErr: true},
		{p: "data/tests/dir0/dir1/dir2/e.jsgf", want: productions, wantErr: false},
	}
	for i, test := range table {
		var err error
		grammar := NewGrammar()
