...
func TestExpressionToTokens(t *testing.T) {
	...
	table := []struct {
		...
		{e: "", exp: []Expression{}},
		{e: ";", exp: []Expression{"<SOS>", ";", "<EOS>"}},
		{e: " ", exp: []Expression{"<SOS>", " ", "<EOS>"}},
		{e: "test expression 123", exp: []Expression{"<SOS>", "test expression 123", "<EOS>"}},
		{e: "test expression 123;", exp: []Expression{"<SOS>", "test expression 123", ";", "<EOS>"}},
		{
...
func TestExpressionParseWeight(t *testing.T) {
	...
	table := []struct {
		...
		{e: "", ee: "", ef: 0.0, err: dummyError},
		{e: "/", ee: "/", ef: 0.0, err: dummyError},
		{e: "//", ee: "//", ef: 0.0, err: dummyError},
		{e: "/.//", ee: "/.//", ef: 0.0, err: dummyError},
		{e: "abc", ee: "abc", ef: 0.0, err: dummyError},
		{e: "abc//", ee: "abc//", ef: 0.0, err: dummyError},
		{e: "/aaa/", ee: "/aaa/", ef: 0.0, err: dummyError},
		{e: "/1.0/", ee: "", ef: 1.0, err: nil},
		{e: "abc/1.0/", ee: "abc", ef: 1.0, err: nil},
		{e: "abc/0.1/", ee: "abc", ef: 0.1, err: nil},
		{e: "abc/0.001/", ee: "abc", ef: 0.001, err: nil},
		{e: "abc/100000/", ee: "abc", ef: 100000.0, err: nil},
		{e: "abc/100000.0/", ee: "abc", ef: 100000.0, err: nil},
		{e: "abc/1/", ee: "abc", ef: 1, err: nil},
		{e: "abc/-1/", ee: "abc", ef: -1.0, err: nil},
		{e: "abc/-1.0/", ee: "abc", ef: -1.0, err: nil},
		{e: "abc/0/", ee: "abc", ef: 0.0, err: nil},
	}
	for i, test := range table {
