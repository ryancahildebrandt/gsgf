...
func TestGraphToTXT(t *testing.T) {
	tests := []struct {
		...
		{
			g: Graph{
				Tokens: []Expression{"a", "b", "c"}, Edges: EdgeList{{From: 0, To: 1, Weight: 1.0}, {From: 1, To: 2, Weight: 1.0}},
		...
		{
			g: Graph{
				Tokens: []Expression{"a", "b", "c", "", "e"}, Edges: EdgeList{
		...
		{
			g: Graph{
				Tokens: []Expression{"a", "b", "c", "d", "e"}, Edges: EdgeList{
					{From: 0, To: 1, Weight: 1.0},
					{From: 0, To: 3, Weight: 0.99},
					{From: 0, To: 5, Weight: 0.0},
					{From: 1, To: 6, Weight: 100},
